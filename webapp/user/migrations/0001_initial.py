    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_uuid', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False, verbose_name='유저 고유번호')),
                ...
                ('thumbnail_image', models.ImageField(upload_to='', verbose_name='일반 유저 썸네일 이미지')),
